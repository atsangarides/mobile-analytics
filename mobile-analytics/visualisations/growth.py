...
def plot_users_per_period(events, acquisition_event_name, period='w'):
    """
    ...
    df = users_per_period(events, acquisition_event_name, period)
    ...
    layout = dict(
        autosize=True,
        barmode='group',
        title='New/Returning User Ratio, Growth,<br>app usage and user acquisition',
        margin={"l": 100, "r": 0, "t": 10, "b": 50, "pad": 0},
        showlegend=True,
